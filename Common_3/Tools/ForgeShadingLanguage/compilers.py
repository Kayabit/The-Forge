...
def get_compiler_from_env(varname, subpath = None, _assert=True):
    ...
    # TODO: AP: not 100% confident in this additional check for "darwin" here. 
    #  seems like it should help but in practice there might have been some weird things happening
